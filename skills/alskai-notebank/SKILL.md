...
- Article discovery by public account name, recent posts, a mirror column URL, or an RSS or subscription feed: **read and follow [Discover articles](references/discover.md)**.
...
- Discovery is performed by the CLI; do not scrape Sogou or mirror sites in the Agent, and do not automatically archive search or feed results.
